...
const options = {
    ...
    pgDefaultRole: "ANONYMOUS", // The default Postgres role that will be used if no role was found in jwtToken. It is a best security practice to always have a value for this option even though it is optional.
