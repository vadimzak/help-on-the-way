...
const continueIfErrorIsDuplicateKey = stringifiedError => {
	...
	let volunteerExistsInGroup =
		error.message.indexOf('duplicate key value violates unique constraint') > -1 ||
		error.message.indexOf('violates foreign key constraint') > -1;
