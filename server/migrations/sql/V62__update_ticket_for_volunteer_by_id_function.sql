...
RETURNS help.ticket_for_volunteer AS $$
    ...
    if (!isVolunteerAllowedToTicket) throw 'user "' + currentUserId + '" is unauthorized for ticket ' + id;
...
GRANT EXECUTE ON FUNCTION help.update_ticket_for_volunteer_by_id(id bigint, data jsonb) TO "VOLUNTEER";
